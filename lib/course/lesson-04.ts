  ...
  "message": "รับคำสั่งซื้อแล้ว กำลังดำเนินการ"
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          text: 'ในชีวิตจริงผู้ใช้ทั่วไปไม่ได้เปิด Postman แต่กรอกฟอร์มบนเว็บแล้วกดส่ง ซึ่งเบื้องหลังคือ POST ไปยัง API แบบเดียวกับที่เราเพิ่งทำ ลองเปิดหน้า Playground เพื่อเห็นฟอร์มที่ยิง API จริง พร้อมแสดง request และ response',
        },
        {
          type: 'cards',
          items: [
            {
              meta: 'ลองของจริง',
              title: 'เปิด API Playground →',
              desc: 'กรอกฟอร์มสั่งอาหารแล้วดู request และ response จาก API จริง เหมือนที่ทำใน Postman แต่อยู่ในรูปฟอร์มที่ผู้ใช้ใช้จริง',
              href: '/playground',
            },
          ],
        },
