  ...
  sections: [
    {
      ...
      blocks: [
        {
          type: 'paragraph',
          text: 'บทนี้สรุปลำดับการติดตั้งและรันโปรเจกต์ที่ได้รับมา เพื่อให้ผู้เรียนเปิดใช้งาน แก้ไข และทดสอบเองได้อย่างเป็นขั้นตอน',
        },
        // ── Step 1 ──────────────────────────────────────────────────────────
        {
          type: 'heading',
...
cd <project-folder>`,
        ...
        {
          type: 'paragraph',
          text: 'หรือถ้าได้รับโปรเจกต์เป็นไฟล์ .zip',
        },
        {
          type: 'list',
          ordered: true,
...
npx expo start`,
        ...
        {
          type: 'paragraph',
          text: 'ก่อนสรุปว่า App ทำงานได้ครบ ควรทดสอบ API ผ่าน Postman หรือ Thunder Client แยกต่างหากด้วย',
        },
        {
          type: 'code',
          lang: 'text',
